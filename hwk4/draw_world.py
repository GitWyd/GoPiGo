...
class Maze(object):
    ...
    def draw():
    	drawShapes(self.origin, self.boundaries)
    	for obstacle in self.obstacles:
    		drawShapes(self.obstacle[0], obstacle, OBSTACLE_LINE_COLOR, OBSTACLE_FILL_COLOR)

    def drawShapes(start, points, lineColour="blue", fillColour="white"):
	    turtle.penup()
